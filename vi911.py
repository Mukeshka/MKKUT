...
if(expirydate>today):
    ...
    Firstend = now.replace(hour=21, minute=35, second=0, microsecond=0)
    Second = now.replace(hour=21, minute=55, second=0, microsecond=0)
    Secondend = now.replace(hour=22, minute=35, second=0, microsecond=0)
    Third = now.replace(hour=22, minute=55, second=0, microsecond=0)
    Thirdend = now.replace(hour=23, minute=35, second=0, microsecond=0)
    ...
    if (False):
        ...
        print("14 Sept 2021, 09:00 PM- 09:30 PM")
        print("14 Sept 2021, 11:00 PM- 11:30 PM")
